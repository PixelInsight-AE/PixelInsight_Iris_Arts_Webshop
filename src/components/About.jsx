        ...
        <div className="about-me-card">
          ...
          <div className="about-me-info">
            ...
            <p>
              ...
              In het middelbaar koos ik voor de richting publiciteit en zo was
              ik nog meer creatief bezig. Tijdens en na de schooluren.
              <br />
              <br />
              Maar Na een grote tegenslag in mijn leven dacht ik even dat ik
              mijn passie kwijt was. Mijn fijne motoriek en concentratie
              vermogen Kregen een flinke klap.
              <br />
              <br />
              ...
              <br /> Na veel tekeningen later , had ik mijn eerste eigen
              ...
              dat ik eigenlijk nog niet helemaal kende , had ik mijn eerste
              kleine ‘Digitaal’ projectje gemaakt.
              ...
              <br /> Ik doe het allemaal even graag ! En dat mag nu gezien
              worden.
            </p>
          </div>
          <div className="about-me-flower">
            <img
              className="flower-image"
              src="https://i.imgur.com/Bn6Q4jK.png"
              alt="flower?"
            />
          </div>
        </div>
